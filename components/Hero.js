          ...
          <div className="text-center pb-12 md:pb-16 ">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center sm:space-x-7">
                ...
                <Link href="/classroom">
                  <button className="transition duration-300 ease-in-out text-white font-normal tracking-wide  bg-gray-900 hover:bg-btc_end  transform hover:-translate-y-1 hover:scale-110 px-5 py-3 rounded-lg w-10/12 mb-4 sm:w-auto sm:mb-0 focus:outline-none">
                    교실 입장하기 &rarr;
                  </button>
                </Link>
              </div>
